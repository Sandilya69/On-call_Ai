...
// import { createClientClient } from '@supabase/auth-helpers-nextjs'; // Using latest Supabase Next auth
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <div className="glass-card w-[420px] p-8 text-center flex flex-col items-center">
          ...
          <div className="flex flex-col gap-3 w-full mb-6">
            <button type="button" onClick={() => handleOAuth('google')} className="flex items-center justify-center gap-3 w-full py-2.5 bg-white/10 hover:bg-white/20 transition-colors border border-white/20 rounded-lg text-white text-sm font-medium">
            ...
            <button type="button" onClick={() => handleOAuth('apple')} className="flex items-center justify-center gap-3 w-full py-2.5 bg-white/10 hover:bg-white/20 transition-colors border border-white/20 rounded-lg text-white text-sm font-medium">
            ...
            <button type="button" onClick={() => handleOAuth('github')} className="flex items-center justify-center gap-3 w-full py-2.5 bg-white/10 hover:bg-white/20 transition-colors border border-white/20 rounded-lg text-white text-sm font-medium">
              <svg viewBox="0 0 24 24" width="18" height="18" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
