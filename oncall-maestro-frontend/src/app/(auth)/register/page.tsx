      ...
      <div className="relative z-10 flex items-center justify-center min-h-full">
        <div className="glass-card w-[520px] p-8 mt-12 text-center flex flex-col items-center">
          ...
          <div className="grid grid-cols-2 gap-2 w-full mb-6">
            <button type="button" onClick={loginWithGoogle} className="flex items-center justify-center gap-2 p-2.5 bg-white/10 hover:bg-white/20 transition-colors border border-white/20 rounded-lg text-white text-xs font-medium" title="Google">
            ...
            <button type="button" onClick={loginWithGithub} className="flex items-center justify-center gap-2 p-2.5 bg-white/10 hover:bg-white/20 transition-colors border border-white/20 rounded-lg text-white text-xs font-medium" title="GitHub">
